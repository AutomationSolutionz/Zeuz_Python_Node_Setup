...
def Installer_With_Pip():
    ...
    pip_module_list = ["pip","psutil", "clint","pillow", "pyserial", "numpy","imutils", "simplejson","urllib3","selenium","uiautomator","requests", "poster","wheel" , "python3-xlib", "pyautogui", "lxml","xlrd","SpeechRecognition","python-dateutil","Appium-Python-Client","futures"]
