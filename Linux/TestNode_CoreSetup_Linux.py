...
pip_module_list = ["pip", "psutil", "pillow","pyserial", "numpy","imutils", "simplejson","urllib3","selenium","requests", "poster","wheel", "pyautogui", "Appium-Python-Client", "lxml", "gi","xlrd", "pyscreenshot","tzlocal"]
